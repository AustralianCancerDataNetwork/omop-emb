...
def pg_engine():
    ...
    if DB_HOST is None or DB_PORT is None or not DB_PORT.isdigit():
        pytest.skip(
            "PostgreSQL integration test environment is not configured "
            "(set TEST_DB_HOST and TEST_DB_PORT)."
        )
