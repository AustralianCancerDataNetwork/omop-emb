...
def _build_concept_filter(
    *,
    ...
    resolved_domains = tuple(domains) if domains else None
    if not standard_only and resolved_vocabularies is None and resolved_domains is None:
        return None
...
def add_embeddings(
    ...
    with Session(engine) as reader, Session(engine) as writer:
        ...
        total_concepts = num_embeddings or estimated_total_concepts
